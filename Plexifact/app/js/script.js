...
function goSlider(znak) {
    ...
    $.each(array, function(index, value) {
        ...
        if (el_value == true) {
            ...
            $(".advantages").children('.advantages__slide--active').removeClass('advantages__slide--active');
            $(".advantages").children('.advantages__slide')[next__active].classList.add('advantages__slide--active');
            return false;
        }
    });
}
...
function change_text(number) {
    ...
    $('.advantages__methodology__item.advantages__methodology__item--active').removeClass('advantages__methodology__item--active')
...
function vacancies() {
    $(this).find('.vacancies__title__arrow').toggleClass('vacancies__title__arrow--active')
